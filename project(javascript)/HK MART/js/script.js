...
// Array of product objects (duplicate of products.mjs)
const products = [
  {
    id: 1,
...

  {
    ...
    price: 79.99,
    image:
      "https://www.bajajelectricals.com/cdn/shop/files/350014-6.jpg?v=1762257474&width=1500",
...
// Function to initialize products in localStorage (only if not present)
...
// Function to get products from localStorage or default array
const getProducts = () => {
