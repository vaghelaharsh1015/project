  ...
  return (
    <div className="animate-fadeIn">
      ...
      <div className="max-w-7xl mx-auto px-4 md:px-8 py-16 grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
        <div>
          <img src="https://images.unsplash.com/photo-1583511655857-d19b40a7a54e?w=800" alt="About us" className="border border-brand-border shadow-md object-cover w-full h-[450px]" />
        </div>
